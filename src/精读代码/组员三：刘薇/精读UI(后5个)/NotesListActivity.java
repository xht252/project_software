...
public class NotesListActivity extends Activity implements OnClickListener, OnItemLongClickListener {
    ...
    private void initResources() {
        mContentResolver = this.getContentResolver(); //获取应用程序的数据，得到类似数据表的信息
    ...
    //从ListView.MultiChoiceModeListener和OnMenuItemClickListener继承
    ...
    //根据不同类型的weight更新插件，通过intent传送数据
